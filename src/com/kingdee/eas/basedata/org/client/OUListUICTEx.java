...
import com.kingdee.eas.custom.MessageToSD.ImaterielAddStock;
import com.kingdee.eas.custom.MessageToSD.SaleIssueBillFactory;
import com.kingdee.eas.custom.MessageToSD.materielAddStockFactory;
...
//		String dataInfo = "{'dataInfo':{'bizNumber':'001001001','bizDate':'2020-10-27','bizOrg':'066','doctor':'65e3a36421714da0a09b27e6d3363ca0','customer':'XH01427','entry':[{'entryId':'464d12c1','materialNum':'101222','flot':'1','qty':'1.002'}]}}";
//		ISaleIssueBill salebill = SaleIssueBillFactory.getRemoteInstance();
//		salebill.addSaleIssueBillInfo(dataInfo);
		
//		String orgcode = "{'number':'Gobrite-US-35&6','bizOrg':'066'}";
