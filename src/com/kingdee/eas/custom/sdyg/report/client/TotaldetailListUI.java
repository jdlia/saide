 ...
 * output class name
 */
public class TotaldetailListUI extends AbstractTotaldetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TotaldetailListUI.class);
    
    /**
     * output class constructor
     */
    public TotaldetailListUI() throws Exception
    {
        super();
    }
