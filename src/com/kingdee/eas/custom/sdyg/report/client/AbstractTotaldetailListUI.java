 ...
 * output package name
 */
package com.kingdee.eas.custom.sdyg.report.client;
 ...
 * output class name
 */
public abstract class AbstractTotaldetailListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTotaldetailListUI.class);
     ...
     */
    public AbstractTotaldetailListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTotaldetailListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.sdyg.report.app", "TotaldetailQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.sdyg.report.app.TotaldetailListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("entrys.subject.number"));
        sic.add(new SelectorItemInfo("entrys.subjectname"));
        sic.add(new SelectorItemInfo("entrys.debt"));
        sic.add(new SelectorItemInfo("totaltype"));
        sic.add(new SelectorItemInfo("entrys.add"));
        sic.add(new SelectorItemInfo("totalrange.name"));
        sic.add(new SelectorItemInfo("entrys.kmqsfl"));
        return sic;
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTotaldetailListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTotaldetailListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.sdyg.report.client", "TotaldetailListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.sdyg.report.client.TotaldetailEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.sdyg.report.TotaldetailFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.sdyg.report.TotaldetailInfo objectValue = new com.kingdee.eas.custom.sdyg.report.TotaldetailInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","name","entrys.subject.number","totaltype","totalrange.name"};
    }



	protected String getTDFileName() {
    	return "/bim/custom/sdyg/report/Totaldetail";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.sdyg.report.app.TotaldetailQuery");
	}
