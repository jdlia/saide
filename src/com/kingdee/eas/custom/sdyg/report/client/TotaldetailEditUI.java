 ...
 * output class name
 */
public class TotaldetailEditUI extends AbstractTotaldetailEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TotaldetailEditUI.class);
    
    /**
     * output class constructor
     */
    public TotaldetailEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    public void onLoad() throws Exception {
    	super.onLoad();
        	...
        	filterInfo.getFilterItems().add(new FilterItemInfo("companyID.id", "00000000-0000-0000-0000-000000000000CCE7AED4"));
        	evi.setFilter(filterInfo);
    	 	settNumPromptBox.setEntityViewInfo(evi);
    	 	kdtEntrys.getColumn("subject").setEditor(new KDTDefaultCellEditor(settNumPromptBox));
