...
public class TotaldetailControllerBean extends AbstractTotaldetailControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.report.app.TotaldetailControllerBean");
}