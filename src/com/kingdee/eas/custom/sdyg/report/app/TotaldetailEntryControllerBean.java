...
public class TotaldetailEntryControllerBean extends AbstractTotaldetailEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.report.app.TotaldetailEntryControllerBean");
}