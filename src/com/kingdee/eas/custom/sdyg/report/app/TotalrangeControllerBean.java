...
public class TotalrangeControllerBean extends AbstractTotalrangeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.report.app.TotalrangeControllerBean");
}