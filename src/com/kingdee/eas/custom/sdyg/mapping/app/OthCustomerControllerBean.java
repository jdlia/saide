...
public class OthCustomerControllerBean extends AbstractOthCustomerControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.mapping.app.OthCustomerControllerBean");
}