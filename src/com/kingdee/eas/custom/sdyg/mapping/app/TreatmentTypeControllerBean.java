...
public class TreatmentTypeControllerBean extends AbstractTreatmentTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.mapping.app.TreatmentTypeControllerBean");
}