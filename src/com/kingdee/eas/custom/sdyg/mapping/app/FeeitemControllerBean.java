...
public class FeeitemControllerBean extends AbstractFeeitemControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.mapping.app.FeeitemControllerBean");
}