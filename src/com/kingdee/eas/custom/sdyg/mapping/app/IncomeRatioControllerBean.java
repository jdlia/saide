...
public class IncomeRatioControllerBean extends AbstractIncomeRatioControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.mapping.app.IncomeRatioControllerBean");
}