...
public class NodeTypeControllerBean extends AbstractNodeTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.mapping.app.NodeTypeControllerBean");
}