...
public class OrgmapEntryControllerBean extends AbstractOrgmapEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.mapping.app.OrgmapEntryControllerBean");
}