...
public class DoctorLevelControllerBean extends AbstractDoctorLevelControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.sdyg.mapping.app.DoctorLevelControllerBean");
}