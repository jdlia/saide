 ...
 * output class name
 */
public class TreatmentNodeCodingListUI extends AbstractTreatmentNodeCodingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TreatmentNodeCodingListUI.class);
    
    /**
     * output class constructor
     */
    public TreatmentNodeCodingListUI() throws Exception
    {
        super();
    }
