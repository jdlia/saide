 ...
 * output class name
 */
public abstract class AbstractOthCustomerListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOthCustomerListUI.class);
    /**
     * output class constructor
     */
    public AbstractOthCustomerListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.sdyg.mapping.app.OthCustomerListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.sdyg.mapping.client", "OthCustomerListUI");
    }
