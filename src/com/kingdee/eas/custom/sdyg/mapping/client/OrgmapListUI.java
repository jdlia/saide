...
import com.kingdee.eas.custom.sdyg.InitBillInfoFacadeFactory;
 ...
 * output class name
 */
public class OrgmapListUI extends AbstractOrgmapListUI
{
     ...
     */
    public OrgmapListUI() throws Exception
    {
        super();
    }
...
//			return;
		...
		for (Iterator iter = pkList.iterator(); iter.hasNext();) {
			...
			OrgmapInfo orgmapInfo = OrgmapFactory.getRemoteInstance().getOrgmapInfo(new ObjectUuidPK(id));
			InitInfoFacadeFactory.getRemoteInstance().syncGetmark(orgmapInfo.getBizID());
		}
