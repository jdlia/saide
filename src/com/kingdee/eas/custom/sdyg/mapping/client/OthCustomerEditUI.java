 ...
 * output class name
 */
public class OthCustomerEditUI extends AbstractOthCustomerEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(OthCustomerEditUI.class);
    
    /**
     * output class constructor
     */
    public OthCustomerEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    {
    	OthCustomerInfo billInfo = (OthCustomerInfo) this.editData;
