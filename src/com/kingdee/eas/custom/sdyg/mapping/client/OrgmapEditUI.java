 ...
 * output class name
 */
public class OrgmapEditUI extends AbstractOrgmapEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(OrgmapEditUI.class);
    
    /**
     * output class constructor
     */
    public OrgmapEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    {
    	OrgmapInfo billInfo = (OrgmapInfo) this.editData;
