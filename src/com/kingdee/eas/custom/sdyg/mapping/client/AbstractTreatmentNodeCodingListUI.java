 ...
 * output class name
 */
public abstract class AbstractTreatmentNodeCodingListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTreatmentNodeCodingListUI.class);
    /**
     * output class constructor
     */
    public AbstractTreatmentNodeCodingListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.sdyg.mapping.app.TreatmentNodeCodingListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.sdyg.mapping.client", "TreatmentNodeCodingListUI");
    }
