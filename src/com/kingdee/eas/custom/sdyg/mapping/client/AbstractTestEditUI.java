 ...
 * output class name
 */
public abstract class AbstractTestEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTestEditUI.class);
     ...
     */
    public AbstractTestEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTestEditUI.class.getName());
        ...
        // txtDescription
        // prmtBIMUDF0001		
        this.prmtBIMUDF0001.setQueryInfo("com.kingdee.eas.basedata.scm.common.app.ExpenseItemQuery");		
        this.prmtBIMUDF0001.setVisible(true);		
        this.prmtBIMUDF0001.setEditable(true);		
        this.prmtBIMUDF0001.setDisplayFormat("$status$");		
        this.prmtBIMUDF0001.setEditFormat("$number$");		
        this.prmtBIMUDF0001.setCommitFormat("$number$");		
        this.prmtBIMUDF0001.setRequired(false);
        // prmtBIMUDF0002		
        this.prmtBIMUDF0002.setQueryInfo("com.kingdee.eas.basedata.scm.common.app.ExpenseTypeQuery");		
    ...
    public void initUIContentLayout()
    {
        ...
        contBIMUDF0001.setBounds(new Rectangle(425, 203, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.sdyg.mapping.app.TestEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.sdyg.mapping.TestInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.sdyg.mapping.client", "TestEditUI");
    }
