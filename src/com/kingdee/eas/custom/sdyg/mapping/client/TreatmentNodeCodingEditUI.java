 ...
 * output class name
 */
public class TreatmentNodeCodingEditUI extends AbstractTreatmentNodeCodingEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TreatmentNodeCodingEditUI.class);
    
    /**
     * output class constructor
     */
    public TreatmentNodeCodingEditUI() throws Exception
    {
        super();
    }
    /**
