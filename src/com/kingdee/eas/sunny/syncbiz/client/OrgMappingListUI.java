 ...
 * output class name
 */
public class OrgMappingListUI extends AbstractOrgMappingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OrgMappingListUI.class);
    
    /**
     * output class constructor
     */
    public OrgMappingListUI() throws Exception
    {
        super();
    }
